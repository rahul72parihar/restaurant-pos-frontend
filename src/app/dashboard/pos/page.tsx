...
export default function POSPage() {
  ...
  useEffect(() => {
    let f = menuItems;
    if (activeCat !== "all")
      f = f.filter((i) => i.category?.name === activeCat);
    if (search)
      f = f.filter((i) => i.name.toLowerCase().includes(search.toLowerCase()));
    setFiltered(f);
          ...
          {filtered.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute top-2 right-2 w-3 h-3 border-2 rounded-sm flex items-center justify-center ${
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-gray-100 pr-5 leading-tight line-clamp-2">
                  {item.name}
                </p>
                <p className="text-orange-600 dark:text-orange-400 font-bold text-sm mt-1.5">
        ...
        <div className="p-4 border-b border-gray-100 dark:border-gray-700">
          ...
          <div className="flex gap-2 mt-2">
            <input
              ...
              className="flex-1 px-3 py-2 text-xs bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400"
            />
            <button
              onClick={searchCustomer}
              className="px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded-xl hover:bg-orange-50 transition-colors"
            >
            ...
            >
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="w-6 h-6 bg-gray-200 dark:bg-gray-600 rounded-lg flex items-center justify-center hover:bg-orange-100 transition-colors"
                >
        ...
        <div className="px-4 pb-2">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 text-xs bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400 uppercase"
            />
            <button
